...
void showStatus(Cpu& cpu) {
  ...
  cout << "$zero(reg[0])  : " << setw(10) << setfill(' ') << left << cpu[0] << string(4, ' ') 
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_NOP] << "| sqrt       : " << a[Cpu::NUM_SQRT] << endl;
  cout << "$v0  (reg[1])  : " << setw(10) << setfill(' ') << left << cpu[1] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_ADD] << "| sin        : " << a[Cpu::NUM_SIN] << endl;
  cout << "$a0  (reg[2])  : " << setw(10) << setfill(' ') << left << cpu[2] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_SUB] << "| cos        : " << a[Cpu::NUM_COS] << endl;
  cout << "$a1  (reg[3])  : " << setw(10) << setfill(' ') << left <<  cpu[3] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_ADDI] << "| floor      : " << a[Cpu::NUM_FLOOR] << endl;
  cout << "$a2  (reg[4])  : " << setw(10) << setfill(' ') << left << cpu[4] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_LW] << "| atan       : " << a[Cpu::NUM_ATAN] << endl;
  cout << "$a3  (reg[5])  : " << setw(10) << setfill(' ') << left << cpu[5] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_SW] << "| itof       : " << a[Cpu::NUM_ITOF] << endl;
  cout << "$a4  (reg[6])  : " << setw(10) << setfill(' ') << left << cpu[6] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_AND] << "| ftoi       : " << a[Cpu::NUM_FTOI] << endl;
  cout << "$a5  (reg[7])  : " << setw(10) << setfill(' ') << left << cpu[7] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_ANDI] << "| print_int  : " << a[Cpu::NUM_PRINT_INT] << endl;
  cout << "$a6  (reg[8])  : " << setw(10) << setfill(' ') << left << cpu[8] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_OR] << "| read_int   : " << a[Cpu::NUM_READ_INT] << endl;
  cout << "$a7  (reg[9])  : " << setw(10) << setfill(' ') << left << cpu[9] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_ORI] << "| read_float : " << a[Cpu::NUM_READ_FLOAT] << endl;
  cout << "$a8  (reg[10]) : " << setw(10) << setfill(' ') << left << cpu[10] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_NEG] << "|" << endl;
  cout << "$a9  (reg[11]) : " << setw(10) << setfill(' ') << left << cpu[11] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_SLL] << "| hlt        : " << a[Cpu::NUM_HLT] << endl;
  cout << "$a10 (reg[12]) : " << setw(10) << setfill(' ') << left << cpu[12] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_SRL] << "| jout       : " << a[Cpu::NUM_JOUT] << endl;
  cout << "$a11 (reg[13]) : " << setw(10) << setfill(' ') << left << cpu[13] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_SLA] << "|" << endl;
  cout << "$a12 (reg[14]) : " << setw(10) << setfill(' ') << left << cpu[14] << string(4, ' ')
    ...
    << setw(10) << setfill(' ') << left << a[Cpu::NUM_SRA] << "|(total)     : " << total << endl;
