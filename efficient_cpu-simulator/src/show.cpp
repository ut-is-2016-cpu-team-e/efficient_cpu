...
void showInstCnt(Cpu& cpu) {
  ...
  mvprintw(j++, 138, "mul   : %llu", a[Cpu::NUM_MUL]);
  ...
  mvprintw(j++, 138, "sl2add: %llu", a[Cpu::NUM_SL2ADD]);
  mvprintw(j++, 138, "beq   : %llu", a[Cpu::NUM_BEQ]);
  mvprintw(j++, 138, "bne   : %llu", a[Cpu::NUM_BNE]);
  mvprintw(j++, 138, "blt   : %llu", a[Cpu::NUM_BLT]);
  mvprintw(j++, 138, "bni   : %llu", a[Cpu::NUM_BNI]);
  mvprintw(j++, 138, "j     : %llu", a[Cpu::NUM_J]);
  mvprintw(j++, 138, "jr    : %llu", a[Cpu::NUM_JR]);
  mvprintw(j++, 138, "jal   : %llu", a[Cpu::NUM_JAL]);
  mvprintw(j++, 138, "push  : %llu", a[Cpu::NUM_PUSH]);
  mvprintw(j++, 138, "pop   : %llu", a[Cpu::NUM_POP]);
  
  j++;
  mvprintw(j++, 138, "li    : %llu", a[Cpu::NUM_LI]);
  mvprintw(j++, 138, "lil   : %llu", a[Cpu::NUM_LIL]);
  mvprintw(j++, 138, "hlt   : %llu", a[Cpu::NUM_HLT]);
  mvprintw(j++, 138, "jout  : %llu", a[Cpu::NUM_JOUT]);
  ...
  mvprintw(j++, 163, "fmadd      : %llu", a[Cpu::NUM_FMADD]);
  mvprintw(j++, 163, "fmsub      : %llu", a[Cpu::NUM_FMSUB]);
  ...
  mvprintw(j++, 163, "bltfabs    : %llu", a[Cpu::NUM_BLTFABS]);
  mvprintw(j++, 163, "fmove      : %llu", a[Cpu::NUM_FMOVE]);
  mvprintw(j++, 163, "mfc1       : %llu", a[Cpu::NUM_MFC1]);
  mvprintw(j++, 163, "mtc1       : %llu", a[Cpu::NUM_MTC1]);
  mvprintw(j++, 163, "flihi      : %llu", a[Cpu::NUM_FLIHI]);
  mvprintw(j++, 163, "flilo      : %llu", a[Cpu::NUM_FLILO]);
  mvprintw(j++, 163, "fneg       : %llu", a[Cpu::NUM_FNEG]);

  j++;
  mvprintw(j++, 163, "fsqrt      : %llu", a[Cpu::NUM_FSQRT]);
  ...
  mvprintw(j++, 163, "print_char : %llu", a[Cpu::NUM_PRINT_CHAR]);
